export const translations = {
    ...
    // --- Glossary Page ---
    'seo_glossary_title': 'Glosarium Istilah Permata & Perhiasan | Vicky Lux Gems',
    'seo_glossary_desc': 'Jelajahi glosarium istilah komprehensif kami terkait amber Burma, permata, perhiasan, dan konsep spiritual untuk meningkatkan pengetahuan dan E-E-A-T Anda.',
    'seo_glossary_keywords': 'glosarium permata, istilah perhiasan, definisi amber, apa itu burmite, apa itu mala, kekerasan mohs, ruby darah merpati, makna cakra, E-E-A-T',
    ...
    'glossary_search_placeholder': 'Cari istilah (misalnya, Mala, Burmite, Chakra)...',
    ...
    'glossary_def_ethically_sourced': 'Merujuk pada permata yang telah ditambang dan diperdagangkan secara bertanggung jawab secara sosial dan lingkungan. Ini termasuk memastikan upah yang adil, kondisi kerja yang aman, dampak lingkungan yang minimal, dan bahwa perdagangan tersebut tidak mendanai konflik.',
    'glossary_term_fossil_resin': 'Resin Fosil',
    'glossary_def_fossil_resin': 'Istilah ilmiah untuk amber. Ini adalah resin pohon yang, selama jutaan tahun, telah mengalami proses polimerisasi dan pengerasan, mengubahnya dari zat lunak dan lengket menjadi batu permata yang keras dan stabil.',
    'glossary_term_gia': 'GIA',
    'glossary_def_gia': 'Institut Gemologi Amerika (Gemological Institute of America). Salah satu otoritas terkemuka di dunia dalam bidang gemologi, terkenal dengan standar penilaiannya yang ketat dan laporan sertifikasi yang komprehensif untuk berlian dan batu permata berwarna.',
    'glossary_term_git': 'GIT',
    'glossary_def_git': 'Institut Permata dan Perhiasan Thailand (The Gem and Jewelry Institute of Thailand). Sebuah lembaga nasional terkemuka di Thailand yang menyediakan pengujian kualitas dan sertifikasi untuk batu permata, terutama penting untuk permata yang bersumber dari Asia Tenggara.',
    'glossary_term_heirloom_quality': 'Kualitas Pusaka',
    'glossary_def_heirloom_quality': 'Istilah yang digunakan untuk menggambarkan perhiasan dengan kualitas dan daya tahan yang luar biasa, dibuat untuk bertahan selama beberapa generasi. Ini menyiratkan penggunaan bahan berkualitas tinggi dan pengerjaan yang unggul, membuatnya cocok untuk diwariskan sebagai harta keluarga.',
    ...
    'glossary_def_mala': 'Juga dikenal sebagai tasbih Japa atau tasbih doa, Mala adalah seuntai manik-manik (secara tradisional 108) yang digunakan dalam berbagai tradisi spiritual seperti Hindu dan Buddha untuk meditasi dan doa. Digunakan untuk menghitung mantra atau napas, membantu praktisi untuk tetap fokus.',
    'glossary_term_metaphysical_properties': 'Sifat Metafisik',
    'glossary_def_metaphysical_properties': 'Merujuk pada atribut spiritual, penyembuhan, atau energik yang diyakini terkait dengan batu permata tertentu. Sifat-sifat ini didasarkan pada pengetahuan sejarah, tradisi spiritual, dan keyakinan intuitif daripada ilmu pengetahuan yang dapat diverifikasi. Contohnya termasuk "kuarsa mawar untuk cinta" atau "kecubung untuk menenangkan".',
    ...
    'glossary_def_pigeon_blood': 'Istilah deskriptif untuk warna yang paling dicari pada rubi. Ini merujuk pada warna merah murni dan cerah dengan sedikit semburat ungu-biru, menyerupai warna darah merpati yang baru disembelih. Istilah ini paling terkenal dikaitkan dengan rubi dari Mogok, Myanmar.',
    'glossary_term_topical_authority': 'Otoritas Topikal',
    'glossary_def_topical_authority': 'Konsep SEO di mana sebuah situs web diakui oleh mesin pencari sebagai ahli definitif pada subjek tertentu. Hal ini dicapai dengan membuat konten yang komprehensif, berkualitas tinggi, dan saling terkait yang mencakup semua aspek suatu topik, seperti yang dilakukan glosarium ini untuk permata.',
